...
public class PickBrandListAdapter extends BaseQuickAdapter<GoodsCategory, BaseViewHolder> {

    Context context;


    public PickBrandListAdapter(@Nullable List<GoodsCategory> data, Context c) {
