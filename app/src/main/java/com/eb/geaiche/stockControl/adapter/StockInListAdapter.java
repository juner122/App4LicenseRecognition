...
public class StockInListAdapter extends BaseQuickAdapter<Goods, BaseViewHolder> {

    Context context;



    public StockInListAdapter(@Nullable List<Goods> data, Context c) {
        super(R.layout.activity_stock_in_item, data);
        this.context = c;
    }
