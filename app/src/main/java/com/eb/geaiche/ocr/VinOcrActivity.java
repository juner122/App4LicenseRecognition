...
public class VinOcrActivity extends BaseActivity {
    ...
    private PermissionCallback permissionCallback = new PermissionCallback() {
        ...
        public boolean onRequestPermission() {
            ActivityCompat.requestPermissions(VinOcrActivity.this,
    ...
    private void initNative(final String token) {
        CameraNativeHelper.init(VinOcrActivity.this, token,
        ...
        public void onPictureTaken(final Bitmap bitmap) {
            CameraThreadPool.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    intent.putExtra(VinOcrActivity.KEY_CONTENT_TYPE, contentType);
    ...
    protected void init() {
        ...
        takePhotoBtn = (ImageView) findViewById(com.baidu.ocr.ui.R.id.take_photo_button);
        findViewById(com.baidu.ocr.ui.R.id.album_button).setOnClickListener(albumButtonOnClickListener);
        takePhotoBtn.setOnClickListener(takeButtonOnClickListener);

        // confirm result;
        displayImageView = (ImageView) findViewById(com.baidu.ocr.ui.R.id.display_image_view);
        ...
        findViewById(com.baidu.ocr.ui.R.id.rotate_button).setOnClickListener(rotateButtonOnClickListener);

        cropView = (CropView) findViewById(com.baidu.ocr.ui.R.id.crop_view);
        cropContainer = (OCRCameraLayout) findViewById(com.baidu.ocr.ui.R.id.crop_container);
        overlayView = (FrameOverlayView) findViewById(com.baidu.ocr.ui.R.id.overlay_view);
