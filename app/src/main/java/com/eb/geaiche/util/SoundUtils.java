...
public class SoundUtils {
    ...
    public static void playSoundByMedia(int rawId) {
        try {
            ...
            try {
                AssetFileDescriptor file = MyApplication.getInstance().getApplicationContext().getResources().openRawResourceFd(
                        rawId);
    ...
    public static void playSound(int rawId) {
        ...
        soundPool.load(MyApplication.getInstance().getApplicationContext(), rawId, 1);
