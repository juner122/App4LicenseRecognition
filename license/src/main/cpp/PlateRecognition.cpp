...
extern "C" {
    ...
    Java_com_frank_plate_PlateRecognition_initPlateRecognizer(JNIEnv *env, jobject,
    ...
    Java_com_frank_plate_PlateRecognition_startRecognize(JNIEnv *env, jobject,
    ...
    Java_com_frank_plate_PlateRecognition_releasePlateRecognizer(JNIEnv *env, jobject, jlong object_re) {
